...
<head>
  ...
  <title>UNPADS - @yield('title')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Unpad</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">UNPAD</b>Padjajaran</span>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b><a href="#!">UNPAD V 1.0</a></b> 
    </div>
    <strong> <a href="#!">Kelompok 2</a></strong> 
  </footer>
